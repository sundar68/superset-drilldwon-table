 ...
 * under the License.
 */
import { Behavior, ChartMetadata, ChartPlugin, t, DrillDown} from '@superset-ui/core';
    ...
    super({
      ...
      transformProps: chartProps => {
        ...
        if (drillDown) {
          outProps.ownState = {
            ...chartProps.ownState,
            drilldown: chartProps.ownState.drilldown?.currentIdx === -1
              ? DrillDown.fromHierarchy(chartProps.formData.filterByCols)
              : chartProps.ownState.drilldown,
          };
          outProps.formData.filterByCols = [
